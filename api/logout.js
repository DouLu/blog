...
// src/.umi/api/logout.ts
var logout_exports = {};
__export(logout_exports, {
  default: () => logout_default2
});
...
async function logout_default(req, res) {
  switch (req.method) {
    case "GET":
      res.setCookie("token", "").json({ success: true, message: "Logged out successfully" });
      break;
    default:
...
` }];
var logout_default2 = async (req, res) => {
  ...
  await logout_default(umiReq, umiRes);
};
